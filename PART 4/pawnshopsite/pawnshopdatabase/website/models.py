...
class Credit(models.Model):
    ...
    def __str__(self):
        return str(self.credit_id) + ' | ' + str(self.client)
...
class Customer(models.Model):
    ...
    def __str__(self):
        return self.first_name + ' ' + self.last_name + ' | ' + self.number_document
...
class Inventory(models.Model):
    ...
    def __str__(self):
        return str(self.inventory_id) + ' | ' + str(self.item)
...
class ItemPledge(models.Model):
    ...
    def __str__(self):
        return str(self.pledge_id) + ' | ' + str(self.item)
...
class Payment(models.Model):
    ...
    def __str__(self):
        return str(self.payment_id) + ' | ' + str(self.payment_credit)
...
class RatedItem(models.Model):
    ...
    def __str__(self):
        return str(self.rate_id) + ' | ' + str(self.item)
...
class Report(models.Model):
    ...
    def __str__(self):
        return str(self.report_id) + ' | ' + str(self.employee)
...
class SoldItem(models.Model):
    ...
    def __str__(self):
        return str(self.sell_id) + ' | ' + str(self.item)
...
class TransactionPayment(models.Model):
    ...
    def __str__(self):
        return str(self.trans_id) + ' | ' + str(self.type_transaction)
